...
const referenceDate = new Date("2025-01-01T12:00:00-08:00");
...
function init(): void {
  ...
  // clouds.cloudLayers[0].height = 10000;
  // clouds.cloudLayers[1].height = 10000;
  // clouds.cloudLayers[2].height = 10000;
